...
related_files:
  - .opencode/references/mes-ai-reference/reference/team-onboarding-guide-summary.md
  - .opencode/references/mes-ai-reference/rules/core/runtime-entry.md
---

# 团队接入规范

> 对应摘要：`.opencode/references/mes-ai-reference/reference/team-onboarding-guide-summary.md`
...
- 常驻总则：`AGENTS.md`
- 加载矩阵：`.opencode/references/mes-ai-reference/reference/skeleton-loading-matrix.md`
...
7. **阶段交接与记忆**：每个阶段退出前必须生成符合 OpenSpec 的主交接文档（如 `spec.md`、`design.md`、`tasks.md`、`test-report.md`、`handover-doc.md`），并同步维护 `mes-ai-dev/workspace/memory/pitfall-ledger.md`、`mes-ai-dev/workspace/memory/decision-log.md`、`mes-ai-dev/workspace/memory/blocker-log.md`
...
统一查阅：`.opencode/references/mes-ai-reference/reference/command-skill-artifact-map.md`
...
可以，但需要确保不同需求不修改同一服务。框架通过 `mes-ai-dev/workspace/locks/` 锁机制防止冲突。
...
| 顺序 | 阅读内容 | 路径 | 目的 |
|------|---------|------|------|
| 1 | AGENTS.md + 骨架加载矩阵 | `AGENTS.md`; `.opencode/references/mes-ai-reference/reference/skeleton-loading-matrix.md` | 理解总则、阶段入口与规则加载方式 |
...
| 顺序 | 阅读内容 | 路径 | 目的 |
|------|---------|------|------|
| 1 | AGENTS.md + 加载矩阵 + 设计阶段规则 | `AGENTS.md`; `.opencode/references/mes-ai-reference/reference/skeleton-loading-matrix.md`; `.opencode/references/mes-ai-reference/rules/phases/phase-design.md` | 全面理解规则总览与设计阶段主线 |
| 2 | API规范 | mes-ai-dev/knowledge/rules/api-conventions.md | 理解API设计规范 |
...
| 8 | 阶段门禁标准 | .opencode/references/mes-ai-reference/reference/phase-gates/index.md | 理解各阶段退出条件 |
...
| 顺序 | 阅读内容 | 路径 | 目的 |
|------|---------|------|------|
| 1 | AGENTS.md + 测试阶段规则 | `AGENTS.md`; `.opencode/references/mes-ai-reference/rules/phases/phase-test.md` | 理解总则与测试阶段边界 |
...
| 7 | 紧急修复流程 | .opencode/references/mes-ai-reference/reference/exception-handbook.md | 理解紧急修复例外流程 |

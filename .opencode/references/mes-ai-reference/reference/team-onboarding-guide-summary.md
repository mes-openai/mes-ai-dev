...
parent_index: .opencode/references/mes-ai-reference/reference/team-onboarding-guide.md
related_files:
...
> 对应正文：`.opencode/references/mes-ai-reference/reference/team-onboarding-guide.md`

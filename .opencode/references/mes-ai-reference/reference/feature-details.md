...
> 知识消费规则：[`.opencode/references/mes-ai-reference/reference/knowledge-consumption/index.md`](knowledge-consumption/index.md)
...
> 阶段记忆治理：[`.opencode/references/mes-ai-reference/reference/stage-memory-governance.md`](stage-memory-governance.md)
...
|------|------|
| `deliverable/` | 正式交付物 |
| `mes-ai-dev/workspace/report/` | 阶段完成产物报告、详细审查报告、步骤门禁报告 |
| `evidence/` | 证据链与验证材料 |
| `handoff/` | 阶段交接与恢复入口 |
| `mes-ai-dev/workspace/memory/` | 坑点台账、决策日志、阻塞台账 |
| `working/` | 草稿与中间工作文件 |

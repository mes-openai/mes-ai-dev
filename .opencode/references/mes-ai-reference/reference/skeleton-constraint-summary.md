...
| 统一状态源 | `state/state.yaml` 是唯一已合并机器事实源；片段与兼容视图不得替代事实源 | `.opencode/references/mes-ai-reference/rules/state/state-core.md`; `.opencode/references/mes-ai-reference/reference/knowledge-consumption/state.md` |

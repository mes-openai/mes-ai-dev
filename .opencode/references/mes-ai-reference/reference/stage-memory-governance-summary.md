...
parent_index: .opencode/references/mes-ai-reference/reference/stage-memory-governance.md
related_files:
  - spec.md
---
...
> 对应正文：`.opencode/references/mes-ai-reference/reference/stage-memory-governance.md`

...
>
> 同时建议配套阅读：
> - `.opencode/references/mes-ai-reference/rules/governance/phase-gate-usage-standard.md`
...
“当前工作采用 GSD 模式时，目标驱动、blocker 分类、最小可交付、GSD DoD 与退出判断，必须符合 `.opencode/references/mes-ai-reference/rules/scenarios/scenario-gsd.md`。”

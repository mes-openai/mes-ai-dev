...
> 对应摘要：`.opencode/references/mes-ai-reference/rules/repository-scale-rules-summary.md`
...
initialization:
  repository_scale:
    ...
    scale_rules: ".opencode/references/mes-ai-reference/rules/repository-scale-rules.md"  # 规则文件路径
    detected_at: "2026-04-13"      # 检测时间
```

## 四点五、相关预算基线

仓规模分类影响上下文预算收紧策略。涉及以下事项时，参考 `.opencode/references/mes-ai-reference/rules/context-budget-baseline.md`：

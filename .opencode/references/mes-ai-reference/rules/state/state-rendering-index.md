...
> 本目录用于替代原 `.opencode/references/mes-ai-reference/rules/state-rendering-spec.md` 的单文件重型结构。
...
原 `.opencode/references/mes-ai-reference/rules/state-rendering-spec.md` 仍保留为兼容导航入口。

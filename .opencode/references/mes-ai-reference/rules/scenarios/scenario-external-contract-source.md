...
related_files:
  ...
  - .opencode/references/mes-ai-reference/rules/governance/contract-knowledge-standard.md
...
“当关键契约对象定义在业务仓之外，涉及 SDK / common / shared / integration、source artifact 或受控反编译时，必须符合 `.opencode/references/mes-ai-reference/rules/scenarios/scenario-external-contract-source.md`。”

...
related_files:
  - .opencode/references/mes-ai-reference/rules/path-canonicalization-rules.md
---

# 路径 canonical 化规则摘要

> 对应正文：`.opencode/references/mes-ai-reference/rules/path-canonicalization-rules.md`

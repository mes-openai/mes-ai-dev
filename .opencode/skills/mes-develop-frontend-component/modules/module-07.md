...
## 输入
- `mes-ai-dev/workspace/designs/REQ-YYYYMMDD-XXX/design.md`（前端UI部分）
- `mes-ai-dev/workspace/designs/REQ-YYYYMMDD-XXX/api-design.md`
- `mes-ai-dev/knowledge/code-map/frontend-overview.md`（公共组件列表）
...
- `web/module-xxx/src/components/` - 现有组件
- `web/common/src/components/` - 公共组件
- 主组件模板：

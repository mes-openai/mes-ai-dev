---
name: mes-develop-backend-model
description: "Develop backend Entity/DTO/VO model classes. Trigger: model, entity, DTO, VO"
---
...
## 适用场景
- Develop backend Entity/DTO/VO model classes. Trigger: model, entity, DTO, VO

...
7. **图谱辅助有边界**：GitNexus 类结果只能作为影响范围、调用链与依赖链辅助证据，必须回写到知识库事实或阶段产物中验证
8. **图谱导读不替代结论**：graphify 类导读只能帮助理解关系，不得替代影响范围结论、风险等级或阶段门禁
...
4. ❌ 不跳过第0层直接读第1层
5. ❌ 不省略风险评估
6. ❌ 不把 GitNexus / graphify 的推断关系直接写成确定事实
7. ❌ 不因图谱提示扩大到当前需求无关仓、服务、表或页面

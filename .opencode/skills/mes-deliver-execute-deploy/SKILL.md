---
name: mes-deliver-execute-deploy
description: "Execute deployment according to plan. Trigger: execute deploy, deploy, rollout, go live"
---
...
## 适用场景
- Execute deployment according to plan. Trigger: execute deploy, deploy, rollout, go live

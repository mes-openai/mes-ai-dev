---
name: mes-develop-database-script
description: "Develop database DDL/DML scripts. Trigger: database script, DDL, DML, SQL, migration"
---
...
## 适用场景
- Develop database DDL/DML scripts. Trigger: database script, DDL, DML, SQL, migration

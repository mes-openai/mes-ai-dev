# mes-init-verify-knowledge / empty-template-block 资源说明
...
## 观察点
- 该用例模拟的核心异常/风险是：api-conventions.md 只有标题，没有任何内容。
...
## 回归判定提示
- 若未能命中该风险并输出“应判定知识库不完整并阻断通过。”，则说明该 Skill 对该类问题的回归覆盖仍不足。
...
## 附带片段文件
- `api-conventions-empty.md`
- `reference-scan-result.md`

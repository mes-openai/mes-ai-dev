---
name: mes-develop-backend-dao
description: "Develop data access layer Mapper/Repository. Trigger: DAO, mapper, repository, MyBatis"
---
...
## 适用场景
- Develop data access layer Mapper/Repository. Trigger: DAO, mapper, repository, MyBatis

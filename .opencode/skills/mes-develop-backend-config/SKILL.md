---
name: mes-develop-backend-config
description: "Develop backend configuration changes. Trigger: configuration, application.yml, properties"
---
...
## 适用场景
- Develop backend configuration changes. Trigger: configuration, application.yml, properties

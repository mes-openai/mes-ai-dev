---
name: mes-develop-frontend-page
description: "Develop Vue page components with routes. Trigger: Vue page, route, view"
---
...
## 适用场景
- Develop Vue page components with routes. Trigger: Vue page, route, view

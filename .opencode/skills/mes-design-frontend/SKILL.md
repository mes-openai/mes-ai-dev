---
name: mes-design-frontend
description: "Design frontend interaction, components, routes. Trigger: frontend design, UI, Vue design"
---
...
## 适用场景
- Design frontend interaction, components, routes. Trigger: frontend design, UI, Vue design

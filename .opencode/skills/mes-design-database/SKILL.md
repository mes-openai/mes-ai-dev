---
name: mes-design-database
description: "Design database schema changes, indexes, migration. Trigger: database design, DDL, schema"
---
...
## 适用场景
- Design database schema changes, indexes, migration. Trigger: database design, DDL, schema

...
- **业务参考知识（必须）**
  - 数据字典：`mes-ai-dev/knowledge/reference/data-dictionary.md` — 字段定义需与数据字典对齐
  - 枚举注册表：`mes-ai-dev/knowledge/reference/enum-registry.md` — 状态字段需使用已注册的枚举值
  - 领域模型：`mes-ai-dev/knowledge/reference/domain-model.md` — 表设计需与领域实体对齐

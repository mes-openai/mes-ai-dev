---
name: mes-develop-frontend-api
description: "Develop frontend API call layer. Trigger: frontend API, axios, request method"
---
...
## 适用场景
- Develop frontend API call layer. Trigger: frontend API, axios, request method

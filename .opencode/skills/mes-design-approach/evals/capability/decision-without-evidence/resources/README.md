# mes-design-approach / decision-without-evidence 资源说明

## 场景类型
- 风险场景

## 模拟输入
- 最终技术决策没有绑定需求、现状或约束证据。
...
## 观察点
- 该用例模拟的核心异常/风险是：最终技术决策没有绑定需求、现状或约束证据。
...
## 回归判定提示
- 若未能命中该风险并输出“应要求补证并重述决策依据。”，则说明该 Skill 对该类问题的回归覆盖仍不足。

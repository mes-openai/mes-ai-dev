# mes-init-extract-reference / empty-template-block 资源说明
...
## 观察点
- 该用例模拟的核心异常/风险是：api-conventions.md 只有标题，没有内容。
...
## 期望结论
- 应识别为空模板，不得当作已提取的真实规范。

## 回归判定提示
- 若未能命中该风险并输出“应识别为空模板，不得当作已提取的真实规范。”，则说明该 Skill 对该类问题的回归覆盖仍不足。

...
并行 Agent A 扫描 mes-production
    ...
    → 只写 mes-ai-dev/knowledge/state/fragments/repo-mes-production.yaml

并行 Agent B 扫描 mes-quality
    → 只写 services/mes-quality/index.md
    → 只写 mes-ai-dev/knowledge/state/fragments/repo-mes-quality.yaml
...
```
每个 scope 维护自己的状态片段：
    mes-ai-dev/knowledge/state/fragments/repo-mes-production.yaml   ← 只记录自己
    mes-ai-dev/knowledge/state/fragments/repo-mes-quality.yaml      ← 只记录自己
    mes-ai-dev/knowledge/state/fragments/schema-mes-data.yaml       ← 只记录自己

收敛时主控串行合并：
    mes-ai-dev/knowledge/state/fragments/*.yaml → mes-ai-dev/knowledge/state/state.yaml（全局）
```

...
| 阶段 | 核心问题 | 主交接文档 / 关键输出 |
|---|---|---|
| 初始化 | 代码仓到底是什么结构、有哪些契约、哪些知识可被下游消费？ | 局部知识产物、状态片段、`report/stage-output-report.md` |
...
| 知识刷新 | 代码变了以后，哪些知识要更新、哪些要收口、哪些暂不更新？ | 变更检测结果、刷新结论、`report/stage-output-report.md` |
...
| 总览节点 / 结论 | 依据来源 |
|---|---|
| 八阶段总链路 | `mes-ai-dev/knowledge/rules/phases/index.md` |

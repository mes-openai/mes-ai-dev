...
| 排名候选 | 对象 | 指标来源 | 指标值 | 说明 | 证据位置 |
|----------|------|----------|--------|------|----------|
| 1 | [对象] | [调用频率/引用数/表访问数] | [值] | [说明] | [路径] |
...
- 本文件为**热点候选片段**，不得直接作为正式热点排行消费。
- 必须经主控或 `/mes-init-converge` 统一重算后，才能写入 `hot-services.md` / `hot-apis.md` / `hot-tables.md`。

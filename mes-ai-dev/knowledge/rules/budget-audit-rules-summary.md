...
parent_index: knowledge/rules/budget-audit-rules.md
related_files:
...
以下内容以 `mes-ai-dev/knowledge/rules/context-budget-baseline.md` 为准：
...
3. 若需查看完整审计细则，再进入 `knowledge/rules/budget-audit-rules.md`

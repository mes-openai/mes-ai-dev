...
- `knowledge/rules/phases/phase-init.md`
...
### 按需加载
- `knowledge/rules/repository-scale-rules.md`
...
- `knowledge/reference/init-output-consumer-matrix.md`
...
- `knowledge/reference/knowledge-consumption/state.md`
- `knowledge/reference/knowledge-consumption/rules.md`
- `knowledge/reference/init-output-consumer-matrix.md`（按需）
- `knowledge/rules/repository-scale-rules.md`（按需）
- `knowledge/rules/budget-audit-rules.md`（按需）
- `knowledge/rules/state/state-rendering-index.md`（按需）
- `knowledge/rules/governance/shared-knowledge-write-policy.md`（按需）
...
## 九、统一引用写法
“初始化阶段的目标边界、模式分类、局部结果产出、续传约束、收口触发与退出判断，必须符合 `knowledge/rules/phases/phase-init.md`。”

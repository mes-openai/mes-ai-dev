...
- 总索引：`knowledge/rules/state/state-rendering-index.md`
- 核心规则：`knowledge/rules/state/state-core.md`
- 初始化片段：`knowledge/rules/state/state-init-fragments.md`
- 收敛边界：`knowledge/rules/state/state-convergence.md`
- 可信度与脏化：`knowledge/rules/state/state-trust.md`

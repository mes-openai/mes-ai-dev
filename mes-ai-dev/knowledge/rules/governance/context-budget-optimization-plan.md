...
### 5.1.2 加载矩阵与索引
- `mes-ai-dev/knowledge/reference/skeleton-loading-matrix.md`
- `mes-ai-dev/knowledge/reference/phase-gates.md`
- `mes-ai-dev/knowledge/reference/phase-gates/index.md`
- `mes-ai-dev/knowledge/reference/phase-gates/common.md`
- `mes-ai-dev/knowledge/reference/knowledge-consumption-matrix.md`
...
- `mes-ai-dev/knowledge/rules/phases/phase-develop.md`
- `mes-ai-dev/knowledge/rules/phases/phase-test.md`
- `mes-ai-dev/knowledge/rules/phases/phase-deliver.md`
- `mes-ai-dev/knowledge/rules/phases/phase-refresh.md`
- `mes-ai-dev/knowledge/rules/phases/phase-emergency.md`
...
- `mes-ai-dev/knowledge/rules/context-budget-baseline.md`
- `mes-ai-dev/knowledge/reference/rule-authority-matrix.md`
- `mes-ai-dev/knowledge/rules/budget-audit-rules-summary.md`
- `mes-ai-dev/knowledge/rules/repository-scale-rules-summary.md`

...
## 一、标准目录
每个阶段 `REQ-YYYYMMDD-XXX` 目录下默认采用：

```text
<phase>/REQ-YYYYMMDD-XXX/
  deliverable/
  report/
  evidence/
  handoff/
...
## 六、统一引用写法
“阶段目录结构与固定文件位置必须符合 `knowledge/rules/governance/stage-artifact-layout.md`。”

...
1. 本文件 `knowledge/rules/core/runtime-entry.md`
2. Core 常驻规则
3. 当前阶段规则
...
### 3.3 当前阶段补充
- 只加载当前阶段的 `knowledge/rules/phases/phase-{stage}.md`
- 只加载 `knowledge/reference/phase-gates/index.md`、`common.md` 与当前阶段门禁分片
- 只加载 `knowledge/reference/knowledge-consumption/index.md` 与当前问题命中的消费分片
...
- index：如 `knowledge/reference/parameter-switch-patterns.md`、`knowledge/reference/terminology-glossary.md`、服务/模块索引
...
设计阶段在生成 `design.md`、`design-doc.md` 或任何设计性结论前，必须完成：

- 后端服务定位
- 前端模块定位
- 命中参数开关场景时对 `knowledge/reference/parameter-switch-patterns.md` 的消费
- 知识来源显式标注
...
元信息标准见：`knowledge/rules/governance/document-load-metadata-standard.md`。
...
- 预算基线：`mes-ai-dev/knowledge/rules/context-budget-baseline.md`
- 优化方案摘要：`mes-ai-dev/knowledge/rules/governance/context-budget-optimization-plan-summary.md`

...
| 你现在想做什么 | 先看哪里 |
|---|---|
| 判断某个文件该由 AI 还是人来维护 | `knowledge/reference/skeleton-artifact-ownership-guide.md` |
| 判断某阶段有哪些产物、该优先看哪些 | `knowledge/reference/stage-artifact-guide.md` |
| 判断某个 Command / Skill 对应什么产物名 | `knowledge/reference/command-skill-artifact-map.md` |
| 判断某阶段该加载哪些规则 | `knowledge/reference/skeleton-loading-matrix.md` |
| 判断骨架修改是否还要同步刷新别的文件 | `knowledge/rules/skeleton-change-governance.md` |
| 判断阶段目录怎么放文件 | `knowledge/rules/governance/stage-artifact-layout.md` |
...
| P2 | `evidence/`、`memory/`、`working/` | 有疑点再下钻 |
...
- `knowledge/reference/knowledge-structure.md`
- `knowledge/reference/workspace-structure.md`

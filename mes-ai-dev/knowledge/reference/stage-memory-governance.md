...
related_files:
  - knowledge/reference/stage-memory-governance-summary.md
  - spec.md
---

# 阶段记忆持久化治理规范

> 对应摘要：`knowledge/reference/stage-memory-governance-summary.md`
...
全局阶段记忆保存在 `knowledge/reference/stage-memory/` 下，用于沉淀具有跨需求、跨阶段、跨仓复用价值的经验。
...
### 4.3 `memory/decision-log.md`

用于记录本阶段的关键决策、备选方案、选定原因与影响范围，并作为 ADR 候选来源。

### 4.4 `memory/blocker-log.md`

...
related_files:
  ...
  - knowledge/rules/scenarios/database-cross-access-rule.md
...
```markdown
> 置信度定义见：`knowledge/reference/glossary-confidence-level.md`
```
...
"涉及置信度标注、候选结论升级、证据来源判断时，必须符合 `knowledge/reference/glossary-confidence-level.md`。"
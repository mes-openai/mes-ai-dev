...
document:
  ...
  path: mes-ai-dev/knowledge/reference/exception-handbook.md
  title: 例外流程手册
  doc_type: reference
  role: body
  load_strategy: explicit-only
  ...
  parent_index: knowledge/reference/skeleton-loading-matrix.md
  related_files:
    - mes-ai-dev/knowledge/reference/exception-handbook-summary.md
```
...
actions:
  - action_id: act_001
    ...
    mode: auto_apply
    status: completed
    target_file: mes-ai-dev/knowledge/reference/exception-handbook-summary.md
    created_files:
      - mes-ai-dev/knowledge/reference/exception-handbook-summary.md
    modified_files: []

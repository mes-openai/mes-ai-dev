...
> 本目录用于替代原 `knowledge/reference/phase-gates.md` 的重型单文件结构。
...
- `knowledge/rules/scenarios/scenario-external-contract-source.md`
...
- 通用门禁要求：`knowledge/reference/phase-gates/common.md`
- GSD 继续退出：`knowledge/reference/phase-gates/gsd-continue-exit.md`
- 各阶段门禁：`knowledge/reference/phase-gates/*.md`
- 审查报告结构：`knowledge/rules/governance/review-report-standard.md`

---

## 六、兼容说明

原 `knowledge/reference/phase-gates.md` 仍保留为兼容导航入口。

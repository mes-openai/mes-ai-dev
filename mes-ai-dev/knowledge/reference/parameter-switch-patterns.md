...
cost_level: low
summary_first: false
parent_index: knowledge/reference/knowledge-consumption/index.md
related_files:
...
3. `knowledge/reference/terminology-glossary.md`
4. `knowledge/reference/parameter-switch-patterns.md`

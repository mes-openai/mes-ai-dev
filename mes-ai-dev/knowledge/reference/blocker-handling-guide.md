...
related_files:
  - knowledge/reference/blocker-handling-guide-summary.md
  - knowledge/reference/exception-handbook.md
---

# 阻塞治理指南

> 对应摘要：`knowledge/reference/blocker-handling-guide-summary.md`
...
- `mes-ai-dev/templates/governance/blocker-record-template.md`（后续新增）

补充说明：

- 原 `mes-ai-dev/knowledge/rules/gsd-execution-mode.md` 已降级为兼容入口。
- 当前 blocker 与 GSD 组合治理以下沉的 `mes-ai-dev/knowledge/rules/scenarios/scenario-gsd.md` 为准。
